...
import com.serpider.service.megastream.adapter.player.PlaybackIconsAdapter;
import com.serpider.service.megastream.model.IconModel;
import com.serpider.service.megastream.model.MediaFiles;
import com.serpider.service.megastream.util.BrightnessDialog;
import com.serpider.service.megastream.util.OnSwipeTouchListener;
import com.serpider.service.megastream.util.Utility;
import com.serpider.service.megastream.util.VolumeDialog;
import java.io.File;
...
public class PlayerActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        videoTitle = getIntent().getStringExtra("URL_TITLE");
        videoUrl = getIntent().getStringExtra("URL_PLAY");
...
//        screenOrientation();
    ...
    private void initViews() {
       ...
       /* double milliseconds = Double.parseDouble(videoUrl.);
        total_duration.setText(Utility.timeConversion((long) milliseconds));*/

        dialogProperties = new DialogProperties();
        filePickerDialog = new FilePickerDialog(PlayerActivity.this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.video_more:
                PopupMenu popupMenu = new PopupMenu(PlayerActivity.this, videoMore);
                    ...
                    public boolean onMenuItemClick(MenuItem menuItem) {
                        switch (menuItem.getItemId()) {
                            ...
                            case R.id.properties:
                                ...
                                android.app.AlertDialog.Builder alertDialog = new android.app.AlertDialog.Builder(PlayerActivity.this);
                                ...
                                String three = "Size: " + android.text.format.Formatter
                                        .formatFileSize(PlayerActivity.this, Long.parseLong(mVideoFiles.get(position).getSize()));
                                ...
                                break;
                            case R.id.delete:
                                android.app.AlertDialog.Builder alertDialogDelete = new android.app.AlertDialog.Builder(PlayerActivity.this);
